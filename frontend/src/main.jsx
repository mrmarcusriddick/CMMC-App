...
function App() {
  ...
  const [page, setPage] = useState(() => window.location.hash.startsWith('#objectives') ? 'objectives' : window.location.hash.startsWith('#summary') ? 'summary' : window.location.hash.startsWith('#poam') ? 'poam' : window.location.hash.startsWith('#audit') ? 'audit' : 'overview');
